...
USER root
RUN dnf update --assumeyes && dnf install --assumeyes gnome-terminal byobu bash-completion pass git gnupg gnupg2 findutils && dnf update --assumeyes && dnf clean all && mkdir /home/${LUSER}/.ssh && mkdir /home/${LUSER}/bin
...
RUN mkdir /home/${LUSER}/private && chown --recursive ${LUSER}:${LUSER} /home/${LUSER}/.ssh /home/${LUSER}/bin /home/${LUSER}/private
USER ${LUSER}
