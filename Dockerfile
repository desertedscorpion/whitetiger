...
USER root
RUN dnf update --assumeyes && dnf install --assumeyes bash-completion pass git g
nupg gnupg2 findutils && dnf update --assumeyes && dnf clean all && mkdir /home/
${LUSER}/.ssh
